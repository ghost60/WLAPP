    ...
    render() {
        return (
            <View style={[styles.container, {...this.props.style}]}>
                <Text style={[styles.names, {width: setSpText(120)}]}>{this.props.name}</Text>
                <TextInput
                    ref={'input'}
                    style={styles.input}
                    selectionColor={Color_Main_Color}
                    keyboardType={this.props.keyboardType}  // 0: 普通  1: 数字
                    placeholder={this.props.field}
                    placeholderTextColor={Color_Text_Gray}
...
const styles = StyleSheet.create({
    container: {
        ...
        height: setSpText(90),
        borderBottomColor: Color_Line_Color,
        borderBottomWidth: setSpText(1),
    },
    names: {
        marginRight: setSpText(40),
    ...
    line: {
        backgroundColor: Color_Line_Color,
        height: setSpText(45),
        width: setSpText(1),
    },
    button: {
